        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">校园风光留言展示</h3>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            xiaoyuanfengguangLiuyanTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('xiaoyuanfengguangLiuyan/list', 'get', param, function(res) {
