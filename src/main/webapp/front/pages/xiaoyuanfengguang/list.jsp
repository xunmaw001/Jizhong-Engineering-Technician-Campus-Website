        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">校园风光展示</h3>
                        ...
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in dataList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
                                    <a @click="jumpCheck('../xiaoyuanfengguang/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="b-link-stripe b-animate-go thickbox">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('xiaoyuanfengguang/list', 'get', param, function(res) {
