    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xiaoyuanfengguangUuidNumber" id="xiaoyuanfengguangUuidNumber" lay-verify="required" placeholder="风光编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xiaoyuanfengguangName" id="xiaoyuanfengguangName" lay-verify="required" placeholder="校园风光名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="xiaoyuanfengguangPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="xiaoyuanfengguangPhoto" name="xiaoyuanfengguangPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="xiaoyuanfengguangTypes" id="xiaoyuanfengguangTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xiaoyuanfengguangClicknum" id="xiaoyuanfengguangClicknum"  lay-verify="required|integer"   placeholder="热度" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`xiaoyuanfengguang/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#xiaoyuanfengguangPhotoImg").attr("src", data.data.xiaoyuanfengguangPhoto);
                });
