        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">新闻资讯信息展示</h3>
                        <p class="index_intro">NEWS</p>
                    </div>
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="portfolio" id="gallery">
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in xiaoyuanfengguangList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="portfolio" id="gallery">
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in shizililiangList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`xiaoyuanfengguang/list`, 'get', {
            ...
            vue.xiaoyuanfengguangList = res.data.list;
        });
        http.request(`shizililiang/list`, 'get', {
            ...
            vue.shizililiangList = res.data.list;
        });
    });
</script>
