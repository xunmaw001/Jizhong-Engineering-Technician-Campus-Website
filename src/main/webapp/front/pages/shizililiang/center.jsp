    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shizililiangUuidNumber" id="shizililiangUuidNumber" lay-verify="required" placeholder="老师工号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shizililiangName" id="shizililiangName" lay-verify="required" placeholder="老师名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="shizililiangPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="shizililiangPhoto" name="shizililiangPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shizililiangTypes" id="shizililiangTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shizililiangShanchang" id="shizililiangShanchang" lay-verify="required" placeholder="擅长" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shizililiangRongyu" id="shizililiangRongyu" lay-verify="required" placeholder="所获荣誉" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`shizililiang/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#shizililiangPhotoImg").attr("src", data.data.shizililiangPhoto);
                });
