            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="nianlingduanTypes" id="nianlingduanTypes" lay-filter="nianlingduanTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in nianlingduanTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="shengyuandiTypes" id="shengyuandiTypes" lay-filter="shengyuandiTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in shengyuandiTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            nianlingduanTypesList : [],
            sexTypesList : [],
            banjiTypesList : [],
            yuanxiTypesList : [],
            shengyuandiTypesList : [],
            xueshengTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function nianlingduanTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=nianlingduan_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.nianlingduanTypesList = res.data.list;
                }
            });
        }
        // 性别的查询
        ...
        function shengyuandiTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shengyuandi_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.shengyuandiTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            var nianlingduanTypes = $("#nianlingduanTypes").find("option:selected").val();
            if (nianlingduanTypes != null && nianlingduanTypes != "" && nianlingduanTypes != "null") {
                param['nianlingduanTypes'] = nianlingduanTypes;
            }
                 
            var banjiTypes = $("#banjiTypes").find("option:selected").val();
            if (banjiTypes != null && banjiTypes != "" && banjiTypes != "null") {
                param['banjiTypes'] = banjiTypes;
            }
         
            var yuanxiTypes = $("#yuanxiTypes").find("option:selected").val();
            if (yuanxiTypes != null && yuanxiTypes != "" && yuanxiTypes != "null") {
                param['yuanxiTypes'] = yuanxiTypes;
            }
         
            var shengyuandiTypes = $("#shengyuandiTypes").find("option:selected").val();
            if (shengyuandiTypes != null && shengyuandiTypes != "" && shengyuandiTypes != "null") {
                param['shengyuandiTypes'] = shengyuandiTypes;
            }
