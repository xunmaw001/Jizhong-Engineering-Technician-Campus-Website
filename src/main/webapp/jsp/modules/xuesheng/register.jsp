...
<body style="background-image:url('/xueyuanwangzhan/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <%--<div class="form-group col-md-12">
                                       <label>年龄段</label>
                                       <select id="nianlingduanTypesSelect" name="nianlingduanTypes" class="form-control">
                                       </select>
                                   </div>--%>
                                   <div class="form-group col-md-12">
                                       <label>性别</label>
                                   ...
                                   <div class="form-group col-md-12">
                                       <label>生源地</label>
                                       <select id="shengyuandiTypesSelect" name="shengyuandiTypes" class="form-control">
                                       </select>
                                   </div>
                                <div class="form-group col-md-12">
