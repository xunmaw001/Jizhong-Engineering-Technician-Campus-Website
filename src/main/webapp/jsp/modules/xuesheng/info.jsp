                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>年龄段</label>
                                    <input style="width: 450px" id="nianlingduanValue" name="nianlingduanValue" class="form-control"
                                           v-model="ruleForm.nianlingduanValue" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>生源地</label>
                                    <input style="width: 450px" id="shengyuandiValue" name="shengyuandiValue" class="form-control"
                                           v-model="ruleForm.shengyuandiValue" readonly>
                                </div>
