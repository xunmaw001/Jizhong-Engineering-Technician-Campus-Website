                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <%--<div class="form-group col-md-6 nianlingduanTypesDiv">
                                        <label>年龄段</label>
                                        <select style="width: 450px" id="nianlingduanTypesSelect" name="nianlingduanTypes" class="form-control">
                                        </select>
                                    </div>--%>
                                    ...
                                    <div class="form-group col-md-6 shengyuandiTypesDiv">
                                        <label>生源地</label>
                                        <select style="width: 450px" id="shengyuandiTypesSelect" name="shengyuandiTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 初始化下拉框
    <!-- 初始化当前表的下拉框 -->
        function initializationNianlingduantypesSelect(){
            var nianlingduanTypesSelect = document.getElementById('nianlingduanTypesSelect');
            if(nianlingduanTypesSelect != null && nianlingduanTypesOptions != null  && nianlingduanTypesOptions.length > 0 ){
                for (var i = 0; i < nianlingduanTypesOptions.length; i++) {
                    nianlingduanTypesSelect.add(new Option(nianlingduanTypesOptions[i].indexName,nianlingduanTypesOptions[i].codeIndex));
                }
            }
        }
        ...
        function initializationShengyuanditypesSelect(){
            var shengyuandiTypesSelect = document.getElementById('shengyuandiTypesSelect');
            if(shengyuandiTypesSelect != null && shengyuandiTypesOptions != null  && shengyuandiTypesOptions.length > 0 ){
                for (var i = 0; i < shengyuandiTypesOptions.length; i++) {
                    shengyuandiTypesSelect.add(new Option(shengyuandiTypesOptions[i].indexName,shengyuandiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(nianlingduanTypesSelect != null && nianlingduanTypesOptions != null  && nianlingduanTypesOptions.length > 0 ) {
            for (var i = 0; i < nianlingduanTypesOptions.length; i++) {
                if (nianlingduanTypesOptions[i].codeIndex == ruleForm.nianlingduanTypes) {//下拉框value对比,如果一致就赋值汉字
                        nianlingduanTypesSelect.options[i].selected = true;
                }
            }
        }
        ...
        if(shengyuandiTypesSelect != null && shengyuandiTypesOptions != null  && shengyuandiTypesOptions.length > 0 ) {
            for (var i = 0; i < shengyuandiTypesOptions.length; i++) {
                if (shengyuandiTypesOptions[i].codeIndex == ruleForm.shengyuandiTypes) {//下拉框value对比,如果一致就赋值汉字
                        shengyuandiTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                age: "required",
                nianlingduanTypes: "required",
                sexTypes: "required",
                banjiTypes: "required",
                yuanxiTypes: "required",
                shengyuandiTypes: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                ...
                age: "年龄不能为空",
                nianlingduanTypes: "年龄段不能为空",
                sexTypes: "性别不能为空",
                banjiTypes: "班级不能为空",
                yuanxiTypes: "院系不能为空",
                shengyuandiTypes: "生源地不能为空",
            }
        }).form();
    }
