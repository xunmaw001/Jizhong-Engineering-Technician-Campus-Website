...
<script>
    ...
    var tableName = "dictionaryShizililiangCollection";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "shizililiang_collection_types";
            data["dicName"] = "收藏表类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"shizililiang_collection_types"}, (res) => {
                if(res.code == 0){
