    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑师资力量留言</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑师资力量留言</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">师资力量留言信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="xueshengId" name="xueshengId" type="hidden">
                                    <div class="form-group col-md-6 shizililiangLiuyanTextDiv">
                                        <label>留言内容</label>
                                        <textarea style="width: 450px"  id="shizililiangLiuyanText" name="shizililiangLiuyanText" class="form-control"placeholder="留言内容"></textarea>
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("shizililiangLiuyan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addshizililiangLiuyan');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                xueshengId: "required",
                shizililiangLiuyanText: "required",
                replyText: "required",
            },
            messages: {
                shizililiangId: "师资力量不能为空",
                xueshengId: "学生不能为空",
                shizililiangLiuyanText: "留言内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addshizililiangLiuyan = window.sessionStorage.getItem("addshizililiangLiuyan");
        if (addshizililiangLiuyan != null && addshizililiangLiuyan != "" && addshizililiangLiuyan != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("shizililiangLiuyan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shizililiangLiuyanText").val(ruleForm.shizililiangLiuyanText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#shizililiangLiuyanText').attr('readonly', 'readonly');
