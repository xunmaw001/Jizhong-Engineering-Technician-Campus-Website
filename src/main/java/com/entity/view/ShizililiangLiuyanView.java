...
public class ShizililiangLiuyanView extends ShizililiangLiuyanEntity implements Serializable {
	...
	public ShizililiangLiuyanView() {

	}

	public ShizililiangLiuyanView(ShizililiangLiuyanEntity shizililiangLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, shizililiangLiuyanEntity);
