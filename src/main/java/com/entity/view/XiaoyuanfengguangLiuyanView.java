...
public class XiaoyuanfengguangLiuyanView extends XiaoyuanfengguangLiuyanEntity implements Serializable {
	...
	public XiaoyuanfengguangLiuyanView() {

	}

	public XiaoyuanfengguangLiuyanView(XiaoyuanfengguangLiuyanEntity xiaoyuanfengguangLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xiaoyuanfengguangLiuyanEntity);
